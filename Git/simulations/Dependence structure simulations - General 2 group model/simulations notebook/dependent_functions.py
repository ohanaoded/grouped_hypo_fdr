...
def plot_metric(metric_index, metric_tite_str, metric_realizations_x_axis, slfdr, clfdr, rs_OMTFDR, rs_OMTpFDR, rs_OMTmFDR):
    ...
    plt.plot(metric_realizations_x_axis, rs_OMTFDR_metric_list , 'r-.' , label = "OMTFDR")
    plt.plot(metric_realizations_x_axis, rs_OMTpFDR_metric_list , 'k:' , label = "OMTpFDR")
    plt.plot(metric_realizations_x_axis, rs_OMTmFDR_metric_list , 'm' , label = "OMTmFDR")
...
def plot_4_metrics(simulation, slfdr, clfdr, rs_OMTFDR, rs_OMTpFDR, rs_OMTmFDR):
    ...
    plot_metric(1, "mFNR", simulation, slfdr, clfdr, rs_OMTFDR, rs_OMTpFDR, rs_OMTmFDR)
